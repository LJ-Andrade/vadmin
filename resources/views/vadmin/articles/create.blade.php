...
@section('content')
	...
	<div class="container">
	    <div class="row">
	        {!! Form::open(['route' => 'articles.store', 'method' => 'POST', 'files' => true, 'id' => 'NewItemForm', 'data-parsley-validate' => '']) !!}	
				<div class="row">
					{{-- Title --}}
					<div class="col-md-6">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="form-group colors-container">
							...
							<div class="ColorPickerList color-picker-list">								
								...
								{{-- <li class="ColorPickerLi"><div class="picked-color"><input type='text' class='ColorPicker' /></div></li> --}}
