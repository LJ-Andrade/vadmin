...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
	...
	<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
		...
		<li class="nav-item has-sub {{ Menu::activeMenu('catalogo') }}">
			<a href="#"><i class="icon-clipboard"></i>
				<span data-i18n="nav.menu_levels.main" class="menu-title">Portfolio</span>
			</a>
			<ul class="menu-content" style="">
				
				<li class="{{ Menu::activeMenu('gallery.index') }}">
					<a href="{{ route('gallery.index') }}" class="menu-item">
						<i class="icon-plus-round"></i> Listado
					</a>
				</li>

				<li class="{{ Menu::activeMenu('gallery.index') }}">
					<a href="{{ route('gallery.create') }}" class="menu-item">
						<i class="icon-plus-round"></i> Nuevo Artículo
					</a>
				</li>
			</ul>
