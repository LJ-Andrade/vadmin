...
<nav id="navfull" class="main-navigation navfull col-md-12">
    <div class="menu-content">        
        <ul>
            <li><a href="@if($current == 'home') #Home @else {{ url('/#Home') }} @endif" onclick="toggleNav()">INICIO</a><div class="nav-line"><div></div></div></li>    
            <li><a href="{{ route('web.portfolio') }}">PORTFOLIO</a><div class="nav-line"><div></div></div></li>
            <li><a href="@if($current == 'home') #Contact @else {{ url('/#Contact') }} @endif" onclick="toggleNav()">CONTACTO</a><div class="nav-line"><div></div></div></li>
        </ul>
    </div>
    <div class="social">
        <div class="inner">
